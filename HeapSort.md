...
---
## Heap Sort 程式碼  
Heap Sort使用 max heap 進行排序，使最大值位於 heap 的根節點，接著將根節點與目前 heap 的最後一個元素交換。Heap Sort的worst-case使用 random permutation generator 產生多組隨機排列，並以其中執行時間最長者作為近似 worst-case time。
```cpp
#include <iostream>
#include <vector>
#include <chrono>
...
```
## 執行結果
<img width="225" height="159" alt="HeapSortOutput" src="https://github.com/user-attachments/assets/36dcc684-acd8-4b4d-b2a4-46dd1dae7121" />
