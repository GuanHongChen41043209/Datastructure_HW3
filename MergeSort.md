...
---
## Merge Sort 程式碼  
Merge Sort 的 worst-case data 是透過反向推導產生。為了讓每一次 merge 時左右兩邊的元素盡量交錯比較。並比較Iterative Merge Sort和Recursive Merge Sort。Iterative Merge Sort從單一元素合併直到整個陣列完成排序。Recursive Merge Sort透過遞迴方式不斷將資料切成左右兩半，再由小到大依序合併。
```cpp
#include <iostream>
#include <vector>
#include <chrono>
...
```
## 執行結果
<img width="233" height="339" alt="MergeSortOutput" src="https://github.com/user-attachments/assets/269bf5a6-5974-49aa-a3f7-1ee05fb6bee7" />
